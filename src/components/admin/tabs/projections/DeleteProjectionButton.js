...
export default function DeleteButton(props) {
    ...
    const handleClick = (e) => {
        ...
        $.ajax({
            type: "POST",
            url: "https://cinematica.8u.cz/php/handlers/dbDeleteProjection.php?key=SG91c2thc2VzYWxhbWVtamVkb2JyYTEyMw==",
            data: { id: props.id },
            ...
            {confirm && 
                <>
                    ...
                    <div className="fixed top-0 left-[50%] ml-[-175px] lg:ml-[-225px] w-[350px] lg:w-[450px] h-fit 2xl:h-fit p-6 mt-80 shadow-md shadow-gray-800 bg-slate-800 rounded-md border-[1px] border-b border-slate-50/[0.1] z-50">
                        <p className="text-lg">Opravdu chcete smazat tohle promítání?</p>
